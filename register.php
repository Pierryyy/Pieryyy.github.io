                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="firstName" placeholder="Nome" class="form-control form-control-lg" />
                        <label class="form-label" for="firstName">Nome</label>
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="lastName" placeholder="Sobrenome" class="form-control form-control-lg" />
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4 d-flex align-items-center">
                      <div class="form-outline datepicker w-100">
                        <input type="text" placeholder="00/00/0000" class="form-control form-control-lg" id="birthdayDate" />
                    ...
                    <label for="cpfnumber" class="form-label">CPF</label>
                  </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-4 pb-2">
                      <div class="form-outline">
                        <input type="tel" id="phoneNumber" placeholder="(00) 000000000" class="form-control phoneNumber-mask" />
